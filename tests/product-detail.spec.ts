...
test.describe('Product Detail Page', () => {
  ...
  test('should navigate to detail page by clicking item name', async ({
    page,
    inventoryPage,
    productDetailPage,
  }) => {
  ...
  test('should display the same name and price as shown on inventory', async ({
    inventoryPage,
    productDetailPage,
  }) => {
    const [firstName] = await inventoryPage.getItemNames();
  ...
  test('should switch to Remove button after adding to cart', async ({
    inventoryPage,
    productDetailPage,
  }) => {
    const [firstName] = await inventoryPage.getItemNames();
  ...
  test('should remove item from cart on detail page', async ({
    inventoryPage,
    productDetailPage,
  }) => {
    const [firstName] = await inventoryPage.getItemNames();
  ...
  test('should return to inventory via back button', async ({
    page,
    inventoryPage,
    productDetailPage,
  }) => {
  ...
  test('should preserve cart badge count on return to inventory', async ({
    inventoryPage,
    productDetailPage,
  }) => {
    const [firstName] = await inventoryPage.getItemNames();
